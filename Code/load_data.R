...
# Section 1: load data
  ...
  # define panel of countries found in Afrobaromter
  ...
  # population data (custom-made for this analysis using Excel)
    pop_subregion = read_excel("population_subregion.xlsx") %>% 
                    filter(used == 1) %>% 
